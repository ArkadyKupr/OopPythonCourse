...
user_list.insert_in_start(2)
user_list.insert_in_start(3)
user_list.insert_in_start(4)
...
print("Значение по указанному индексу:", user_list[1])
print()
...
print("Удаление узла:", user_list.delete_by_data(10))
print(user_list)
print()
