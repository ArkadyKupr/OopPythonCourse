...
print(f"Вместимость = {len(user_array_list_1)}, количество элементов = {user_array_list_1.items_count}")
...
print(f"Вместимость = {len(user_array_list_1)}, количество элементов = {user_array_list_1.items_count}")
print("Возвращенное значение удаленного элемента:", user_array_list_1.pop(2))
print("Список на массиве после удаления:", user_array_list_1)
print("После удаления элемента:")
print(f"Вместимость = {len(user_array_list_1)}, количество элементов = {user_array_list_1.items_count}")
print("Возвращенное значение удаленного элемента:", user_array_list_1.pop(3))
print("Список на массиве после удаления:", user_array_list_1)
...
print(f"Вместимость копированного сиска = {len(copied_user_array_list)}, "
      f"количество элементов = {copied_user_array_list.items_count}")
